...
export async function POST(_request: NextRequest) {
  ...
  // Sin payment_method_types explícitos: Stripe usa los métodos habilitados en el Dashboard.
  // Bizum y tarjeta se activan en: Dashboard → Settings → Payment methods (sin código).
